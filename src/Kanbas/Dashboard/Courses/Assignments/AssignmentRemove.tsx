export default function AssignmentRemove({ dialogTitle, deleteAssignment, assignmentId}:
  { dialogTitle: string; deleteAssignment: (id: string) => void; assignmentId:string}) {
    return (
